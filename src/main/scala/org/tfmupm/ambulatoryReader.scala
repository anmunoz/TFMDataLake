...
object ambulatoryReader {
  def main(args: Array[String]): Unit = {
    ...
    val dfSubjectAlberto = spark.read.format("delta").load(s"$basepath/Subjects/2f73366bc5765cb9bdc1c7f436d03067f200958ff5e7a95635b5577815b62e96")
    val dfSubjectJulian= spark.read.format("delta").load(s"$basepath/Subjects/bdc1c7f436d03067f20092f73366bc5765cb958ff5e7a95635b5577815b62e96")
    val dfSubjectPepe= spark.read.format("delta").load(s"$basepath/Subjects/35b5577815b62e962f73366bc5765cb9bdc1c7f436d03067f200958ff5e7a956")
    val dfTasksPepe = spark.read.format("delta").load(s"$basepath/Subjects/35b5577815b62e962f73366bc5765cb9bdc1c7f436d03067f200958ff5e7a956/tasks")
    val dfTasksJulian = spark.read.format("delta").load(s"$basepath/Subjects/bdc1c7f436d03067f20092f73366bc5765cb958ff5e7a95635b5577815b62e96/tasks")
